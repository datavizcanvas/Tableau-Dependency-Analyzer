...
.mermaid .cluster-label{{font-weight:bold!important;font-size:14px!important}}
...
<div class="dep-grid">
<div class="dep-box high"><strong>🟠 HIGH (5+ Impacted Fields)</strong><span>⚠️ <strong>Critical Impact!</strong> Changing this field will affect <strong>5 or more other fields</strong> directly. Test thoroughly before making any changes.</span></div>
<div class="dep-box medium"><strong>🟡 MEDIUM (2-4 Impacted Fields)</strong><span>⚡ <strong>Moderate Impact.</strong> Changing this field will affect <strong>2 to 4 other fields</strong>. Review all dependencies before modifying.</span></div>
<div class="dep-box low"><strong>🟢 LOW (1 Impacted Field)</strong><span>✓ <strong>Minor Impact.</strong> Only <strong>1 other field</strong> depends on this. Relatively safer to modify.</span></div>
<div class="dep-box none"><strong>⚪ NONE (No Dependent Fields)</strong><span>✓ <strong>No Impact.</strong> No other fields depend on this. <strong>Safest to modify</strong> or delete.</span></div>
</div>
</div>
...
<div class="legend-item"><div class="legend-box" style="background:#fff;border:3px solid #FF1744"></div><span><strong>Selected Field</strong> (clicked)</span></div>
<div class="legend-item"><div class="legend-box" style="background:#fff;border:3px solid #FFD600"></div><span><strong>Impact Fields</strong> (affected)</span></div>
</div>
